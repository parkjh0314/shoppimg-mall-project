...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	public int totalPspecCount(String fk_snum) throws SQLException {
		...
		try {
			...
			rs.next(); //select한 결과의 첫 행으로 커서이동
			
			totalCount = rs.getInt(1); //커서가올라간행의 첫번째컬럼의 값을 가져옴
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	public int likeAdd(Map<String, String> paraMap) throws SQLException {
		...
		}catch (SQLIntegrityConstraintViolationException e) { // 제약조건 위배 exception
			conn.rollback();  // 중복 투표시 : 혹시 지워진게 있다면 rollback해주기
		} finally {
			close();
		}
	...
	public List<ProductVO> selectProductBycategory(Map<String, String> paraMap) throws SQLException {
		...
		try {
			...
			while(rs.next()) {
				...
				pvo.setSaleprice(rs.getInt("saleprice"));		// 제품 판매가(할인해서 팔것이므로)
				...
				pvo.setPoint(rs.getInt("point"));				//포인트

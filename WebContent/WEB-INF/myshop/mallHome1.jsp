...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		displayHIT("1"); //문서가 로딩됨과 동시에 실행됨
		
		// HIT 상품 게시물을 더보기 위하여 "더보기..." 버튼을 클릭액션 이벤트 등록하기 
			...
			$.ajax({
				...
				success:function(json){
					...
					*/
					...
					// 더보기... 버튼의 value 값은이 "9"로 변경된다.
					// 더보기... 버튼의 value 값은이 "17"로 변경된다.
					// 더보기... 버튼의 value 값은이 "25"로 변경된다.
					// 더보기... 버튼의 value 값은이 "33"로 변경된다.
					// 더보기... 버튼의 value 값은이 "41"로 변경된다.

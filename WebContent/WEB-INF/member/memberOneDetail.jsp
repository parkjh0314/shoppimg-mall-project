...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		// 자바스크립트에는 replaceall이 없고 replace밖에 없다.
		// ex) "korea kena" ==> "korea kena".replace("k", "y") ==> "yorea kena"
		// !!! 자바스크립트에서 REPLACE를 REPLACEALL 처럼 사용하기 !! //
		// 변수 goBackURL에 공백 " "dmf ahen "&"로 변경하도록 한다.
		// "korea kena".replace(/k/gi, "y") ==> "yorea yena"
		goBackURL = goBackURL.replace(/ /gi, "&");
		// 정규화식을 이용하여 바꿔줌. gi는 대소문자 구분하지 않는다는 뜻.

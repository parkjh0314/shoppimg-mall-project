...
$(document).ready(function() {
	...
	// 20201105 내 식별코드 : imp20163286 //iamport 계정: hyoile81@gmail.com
   var IMP = window.IMP;     // 생략가능
   IMP.init('imp20163286');  // 중요!!  아임포트에 가입시 부여받은 "가맹점 식별코드". 
   ...
   IMP.request_pay({
       ...
       name : '결제테스트(코인충전|주문명)',	 // 코인충전 또는 order 테이블에 들어갈 주문(제품)명 혹은 주문 번호. (선택항목)원활한 결제정보 확인을 위해 입력 권장(PG사 마다 차이가 있지만) 16자 이내로 작성하기를 권장
       amount : '${coinmoney}',	  // '${coinmoney}'  결제 금액 number 타입. 필수항목. 
